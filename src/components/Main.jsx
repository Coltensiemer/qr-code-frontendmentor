...
export default function Main(){ 
    return (
        ...
        <p className="text-center text-slate-500 font-outfit font-normal color px-8 pb-10">Scan the QR code to visit Frontend Mentor and take your coding skills to the next level</p>
        </div>
    )
}